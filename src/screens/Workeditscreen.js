        ...
        <>
            <View style={styles.container}>
                ...
                <View style={styles.inputview}>
                    ...
                    <TextInput placeholder='Vinod Sharma' style={styles.inputtext} />
                </View>
                <View style={styles.inputview}>
                    <Text style={styles.text}>Requirements:</Text>
                    <TextInput placeholder='React-Native developer' style={styles.inputtext} />
                </View>
                <View style={styles.inputview}>
                    <Text style={styles.text}>Offered Price:</Text>
                    <TextInput placeholder='Rs.500/-' style={styles.inputtext} />
                </View>
                <View style={styles.inputview}>
                    <Text style={styles.text}>Description:</Text>
                    <TextInput placeholder='App building with duration of 20 days ' style={styles.inputtext} />
                </View>
